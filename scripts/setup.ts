...
DATABASE_URL="mongodb://127.0.0.1:27017/nonci" # Create a new MongoDB database and add the connection string here

AMQP_URL="amqp://guest:guest@rabbitmq:5672" # Create a new CloudAMQP instance and add the connection string here
`;
